...
/**
 * ElectricBorder - A glowing, animated border wrapper component
 * 
 * Creates an electric/animated border effect around its children using SVG filters
 * and CSS animations. The border has a turbulent, electric-like appearance with
 * customizable color, speed, chaos level, and thickness.
 * 
 * @param {string} color - Hex color of the border (default: '#5227FF')
 * @param {number} speed - Animation speed multiplier (default: 1)
 * @param {number} chaos - Turbulence intensity (default: 1)
 * @param {number} thickness - Border thickness in pixels (default: 2)
